...
public class DeviceInfo__1 {
     ...
     * @param volumeSize
     */
    public DeviceInfo__1(Integer diskIops, String mountPoints, Integer numVolumes, String storageClass, String storageType, Integer throughput, Integer volumeSize) {
        super();
    ...
    public String toString() {
        ...
        sb.append(DeviceInfo__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("diskIops");
        sb.append('=');
